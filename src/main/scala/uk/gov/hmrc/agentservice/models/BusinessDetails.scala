...
package uk.gov.hmrc.agentservice.models

import play.api.libs.json.Json.reads
import play.api.libs.json.Reads


case class BusinessDetails(businessData: Seq[BusinessData], mtdId: Option[String])

case class BusinessData(tradingName: Option[String], businessAddressDetails: Option[BusinessAddressDetails])
